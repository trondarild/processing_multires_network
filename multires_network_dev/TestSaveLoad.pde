class TestSaveLoad {
    ...
    TestSaveLoad() {
        ...
        // save
        printArray("l1 before", ravel(layer_1.weights()));
        
        JSONObject l1w = layer_1.toJSON();
        // println(l1w.toString());
        JSONArray stack = new JSONArray();
        stack.setJSONObject(0, l1w);
        saveJSONArray(stack, "data/saveloadtest.json");
        
        // load it
        JSONArray loadvalues = loadJSONArray("saveloadtest.json");
        ...
        printArray("l1 after", ravel(layer_1.weights()));
    ...
    void tick() {
        ...
        subm = data; //multiply(1.0/255, getSubmatrix(data_y, data_x, spec_l1.input_size_x, spec_l1.input_size_y, data));
